...
rule all:
    input:
        expand("data\output\{region}\hazard\{event}.tif", region=REGION, event=EVENT),
...
rule sfincs_build:
    ...
    output:
        ...
        sfincs_subgrid_dep="models\sfincs\{region}\subgrid\dep.tif",
    shell:
        """
...
rule pluvial_design_events:
    ...
    output:
        ...
        event_catalog="data\output\{region}\events\event_catalog.yml",
    shell:
        """
