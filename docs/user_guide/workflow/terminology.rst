...
.. glossary::
    ...
    method
        ...
        All methods must have a specific signature to be used in HydroFlows, for more information see the :class:`~workflowpy.Method` class and :ref:`add_own_methods` section.
    ...
    wildcards
        ...
        For more information see the :ref:`compose_workflow` section and :class:`~workflowpy.Wildcards` class.
