...
class Input(BaseModel):
    ...
    required for the WflowUpdateForcing method.
    """
...
class Output(BaseModel):
    ...
    generated by the WflowUpdateForcing method.
    """
...
class Params(BaseModel):
    ...
    Instances of this class are used in the `WflowUpdateForcing`
...
class WflowUpdateForcing(Method):
    ...
    name : str
        ...
        Default is "wflow_update_forcing".
    params : Params
        The parameters to generate wflow forcing, defined by the Params class.
    input : Input
