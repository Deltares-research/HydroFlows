...
class FIATVisualize(Method):
    ...
    **params
        ...
        See :py:class:`fiat_visualize Params <hydroflows.fiat.fiat_visualize.Params>`.

    See Also
    --------
    :py:class:`fiat_visualize Input <hydroflows.fiat.fiat_visualize.Input>`
    :py:class:`fiat_visualize Output <hydroflows.fiat.fiat_visualize.Output>`
    :py:class:`fiat_visualize Params <hydroflows.fiat.fiat_visualize.Params>`
    """
