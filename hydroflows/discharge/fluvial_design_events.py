...
from workflowpy._typing import FileDirPath, ListOfInt, ListOfStr, OutputDirPath
...
class FluvialDesignEvents(ExpandMethod):
    ...
    **params
        ...
        See :py:class:`fluvial_design_events Params <hydroflows.discharge.fluvial_design_events.Params>`.

    See Also
    --------
    :py:class:`fluvial_design_events Input <hydroflows.discharge.fluvial_design_events.Input>`
    :py:class:`fluvial_design_events Output <hydroflows.discharge.fluvial_design_events.Output>`
    :py:class:`fluvial_design_events Params <hydroflows.discharge.fluvial_design_events.Params>`
    :py:class:`hydromt.stats.extremes`
    """
