...
class SetupFloodAdapt(Method):
    ...
    See Also
    --------
    :py:class:`SetupFloodAdapt Input <hydroflows.flood_adapt.setup_flood_adapt.Input>`
    :py:class:`SetupFloodAdapt Input <hydroflows.flood_adapt.setup_flood_adapt.Output>`
    :py:class:`SetupFloodAdapt Input <hydroflows.flood_adapt.setup_flood_adapt.Params>`
    """
