...
class GetCoastRP(Method):
    ...
    See Also
    --------
    :py:class:`GetCoastRP Input <hydroflows.coastal.get_coast_rp.Input>`
    :py:class:`GetCoastRP Output <hydroflows.coastal.get_coast_rp.Output>`
    :py:class:`GetCoastRP Params <hydroflows.coastal.get_coast_rp.Params>`
    """
