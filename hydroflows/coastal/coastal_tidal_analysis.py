...
from workflowpy._typing import OutputDirPath
...
class CoastalTidalAnalysis(Method):
    ...
    See Also
    --------
    :py:class:`CoastalTidalAnalysis Input <hydroflows.coastal.coastal_tidal_analysis.Input>`
    :py:class:`CoastalTidalAnalysis Output <hydroflows.coastal.coastal_tidal_analysis.Output>`
    :py:class:`CoastalTidalAnalysis Params <hydroflows.coastal.coastal_tidal_analysis.Params>`
    """
