...
from hydroflows.coastal.coastal_utils import plot_hydrographs
...
class CoastalDesignEventFromRPData(ExpandMethod):
    ...
    See Also
    --------
    :py:class:`CoastalDesignEventFromRPData Input <hydroflows.coastal.coastal_design_events_from_rp_data.Input>`
    :py:class:`CoastalDesignEventFromRPData Output <hydroflows.coastal.coastal_design_events_from_rp_data.Output>`
    :py:class:`CoastalDesignEventFromRPData Params <hydroflows.coastal.coastal_design_events_from_rp_data.Params>`
    """
