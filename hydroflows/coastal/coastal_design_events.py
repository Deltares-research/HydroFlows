...
class CoastalDesignEvents(ExpandMethod):
    ...
    See Also
    --------
    :py:class:`CoastalDesignEvents Input <hydroflows.coastal.coastal_design_events.Input>`
    :py:class:`CoastalDesignEvents Output <hydroflows.coastal.coastal_design_events.Output>`
    :py:class:`CoastalDesignEvents Params <hydroflows.coastal.coastal_design_events.Params>`
    """
