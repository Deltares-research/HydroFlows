...
class FutureSLR(ExpandMethod):
    ...
    **params
    ...
    See Also
    --------
    :py:class:`FutureSLR Input <hydroflows.coastal.future_slr.Input>`
    :py:class:`FutureSLR Output <hydroflows.coastal.future_slr.Output>`
    :py:class:`FutureSLR Params <hydroflows.coastal.future_slr.Params>`
    """
