...
from workflowpy._typing import FileDirPath, ListOfListOfInt, ListOfStr, OutputDirPath
from workflowpy.method import Method
from workflowpy.parameters import Parameters

from hydroflows.climate.grid_utils import extract_climate_projections_statistics
...
class MonthlyClimatology(Method):
    ...
    **params
        ...
        See :py:class:`climatology Params <hydroflows.climate.climatology.Params>`.

    See Also
    --------
    :py:class:`climatology Input <hydroflows.climate.climatology.Input>`
    :py:class:`climatology Output <hydroflows.climate.climatology.Output>`
    :py:class:`climatology Params <hydroflows.climate.climatology.Params>`
    """
