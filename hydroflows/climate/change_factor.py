...
from workflowpy._typing import ListOfListOfInt, OutputDirPath
from workflowpy.method import ExpandMethod
from workflowpy.parameters import Parameters

from hydroflows.climate.grid_utils import get_expected_change_grid
...
class ClimateChangeFactors(ExpandMethod):
    ...
    **params
        ...
        See :py:class:`change_factor Params <hydroflows.climate.change_factor.Params>`.

    See Also
    --------
    :py:class:`change_factor Input <hydroflows.climate.change_factor.Input>`
    :py:class:`change_factor Output <hydroflows.climate.change_factor.Output>`
    :py:class:`change_factor Params <hydroflows.climate.change_factor.Params>`
    """
