...
class WflowUpdateForcing(Method):
    ...
    **params
        ...
        See :py:class:`wflow_update_forcing Params <hydroflows.wflow.wflow_update_forcing.Params>`.

    See Also
    --------
    :py:class:`wflow_update_forcing Input <hydroflows.wflow.wflow_update_forcing.Input>`
    :py:class:`wflow_update_forcing Output <hydroflows.wflow.wflow_update_forcing.Output>`
    :py:class:`wflow_update_forcing Params <hydroflows.wflow.wflow_update_forcing.Params>`
    :py:class:`hydromt_wflow.WflowModel`
    """
