...
from workflowpy._typing import ListOfPath, OutputDirPath, WildcardPath
from workflowpy.method import ReduceMethod
from workflowpy.parameters import Parameters

from hydroflows.raster.merge_utils import merge_raster_datasets
...
class MergeGriddedDatasets(ReduceMethod):
    ...
    **params
        ...
        See :py:class:`merge Params <hydroflows.raster.merge.Params>`.

    See Also
    --------
    :py:class:`merge Input <~hydroflows.raster.merge.Input>`
    :py:class:`merge Output <~hydroflows.raster.merge.Output>`
    :py:class:`merge Params <~hydroflows.raster.merge.Params>`
    """
