...
from workflowpy._typing import FileDirPath, JsonDict, OutputDirPath
...
class SfincsUpdateForcing(Method):
    ...
    **params
        ...
        See :py:class:`sfincs_update_forcing Params <hydroflows.sfincs.sfincs_update_forcing.Params>`.

    See Also
    --------
    :py:class:`sfincs_update_forcing Input <hydroflows.sfincs.sfincs_update_forcing.Input>`
    :py:class:`sfincs_update_forcing Output <hydroflows.sfincs.sfincs_update_forcing.Output>`
    :py:class:`sfincs_update_forcing Params <hydroflows.sfincs.sfincs_update_forcing.Params>`
    """
