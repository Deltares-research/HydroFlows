...
class SfincsDownscale(Method):
    ...
    **params
        ...
        See :py:class:`sfincs_downscale Params <hydroflows.sfincs.sfincs_downscale.Params>`.

    See Also
    --------
    :py:class:`sfincs_downscale Input <hydroflows.sfincs.sfincs_downscale.Input>`
    :py:class:`sfincs_downscale Output <hydroflows.sfincs.sfincs_downscale.Output>`
    :py:class:`sfincs_downscale Params <hydroflows.sfincs.sfincs_downscale.Params>`
    """
