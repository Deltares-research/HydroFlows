...
from workflowpy._typing import EventDatesDict, FileDirPath, OutputDirPath
from workflowpy.method import ExpandMethod
...
class Input(Parameters):
    ...
    :py:class:`hydroflows.wflow.wflow_update_forcing.WflowBuild`,
    :py:class:`hydroflows.wflow.wflow_update_forcing.WflowUpdateForcing`, and
    :py:class:`hydroflows.wflow.wflow_run.WflowRun` methods) or can be directly supplied by the user.
    """
    ...
    :py:class:`hydroflows.rainfall.get_ERA5_rainfall.GetERA5Rainfall`
    ...
    (can be obtained by the :py:class:`hydroflows.coastal.get_gtsm_data.GetGTSMData` method)
    or can be directly supplied by the user.
    """
...
class HistoricalEvents(ExpandMethod):
    ...
    **params
    ...
    See Also
    --------
    :py:class:`HistoricalEvents Input <hydroflows.historical_events.historical_events.Input>`
    :py:class:`HistoricalEvents Output <hydroflows.historical_events.historical_events.Output>`
    :py:class:`HistoricalEvents Params <hydroflows.historical_events.historical_events.Params>`
    """
