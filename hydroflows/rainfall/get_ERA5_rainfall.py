...
class GetERA5Rainfall(Method):
    ...
    **params
    ...
    See Also
    --------
    :py:class:`GetERA5Rainfall Input <hydroflows.rainfall.get_ERA5_rainfall.Input>`
    :py:class:`GetERA5Rainfall Output <hydroflows.rainfall.get_ERA5_rainfall.Output>`
    :py:class:`GetERA5Rainfall Params <hydroflows.rainfall.get_ERA5_rainfall.Params>`
    """
