...
from hydroflows.rainfall.pluvial_design_events import (
    _plot_hyetograph,
    _plot_idf_curves,
    get_hyetograph,
)
...
class PluvialDesignEventsGPEX(ExpandMethod):
    ...
    **params
    ...
    See Also
    --------
    :py:class:`PluvialDesignEventsGPEX Input <hydroflows.rainfall.pluvial_design_events_GPEX.Input>`
    :py:class:`PluvialDesignEventsGPEX Output <hydroflows.rainfall.pluvial_design_events_GPEX.Output>`
    :py:class:`PluvialDesignEventsGPEX Params <hydroflows.rainfall.pluvial_design_events_GPEX.Params>`
    """
