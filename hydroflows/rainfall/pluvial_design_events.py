...
class PluvialDesignEvents(ExpandMethod):
    ...
    **params
    ...
    See Also
    --------
    :py:class:`PluvialDesignEvents Input <hydroflows.rainfall.pluvial_design_events.Input>`
    :py:class:`PluvialDesignEvents Output <hydroflows.rainfall.pluvial_design_events.Output>`
    :py:class:`PluvialDesignEvents Params <hydroflows.rainfall.pluvial_design_events.Params>`
    """
...
def get_hyetograph(da_idf: xr.DataArray, intensity_dim="duration") -> xr.DataArray:
    ...
    """
    assert intensity_dim in da_idf.dims, (
