...
root = Path(R"p:\11209169-003-up2030\data")
out_root = Path(R"p:\11209169-003-up2030\cases\Rio\preprocessed_data")
...
census_csv_path = Path(
    root, "CENSUS/2010/Base informaçoes setores2010 universo RJ/CSV/Basico_RJ.csv"
)
...
entrances_path = Path(root, "CENSUS/2010/numero_porta.gpkg")
